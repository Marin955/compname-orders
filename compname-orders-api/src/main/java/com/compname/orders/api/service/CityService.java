...
public interface CityService {
    ...
    GetExtendedCityResponse getExtended(GetExtendedCityRequest request) throws OrdersServiceException;
    ...
    SearchExtendedCityResponse searchExtended(SearchExtendedCityRequest request) throws OrdersServiceException;
