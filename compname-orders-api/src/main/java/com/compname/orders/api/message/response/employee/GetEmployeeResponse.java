...
public class GetEmployeeResponse extends ApiPayloadResponse<Employee> {
    public GetEmployeeResponse(ApiRequest request, ResponseCode responseCode, Employee payload) {
