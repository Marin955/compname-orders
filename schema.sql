...
create sequence s_work_hour start 1 increment 1
...
create table work_hours (id int8 not null, from_time timestamp, to_time timestamp, employee_id int8 not null, primary key (id))
...
alter table if exists work_hours add constraint FKbinii6b9kv41x4b33yk9l45nt foreign key (employee_id) references employee
create sequence s_accounts start 1 increment 1
create sequence s_business start 1 increment 1
create sequence s_city start 1 increment 1
create sequence s_employee start 1 increment 1
