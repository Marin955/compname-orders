...
create table term (id int8 not null, created timestamp, from_time timestamp, to_time timestamp, account_id int8 not null, offer_id int8 not null, primary key (id))
...
alter table if exists term add constraint FKi9aj2wqr53w1xd1l64do8yup6 foreign key (offer_id) references offercreate sequence s_accounts start 1 increment 1
create sequence s_business start 1 increment 1
create sequence s_city start 1 increment 1
create sequence s_offer start 1 increment 1
create sequence s_term start 1 increment 1
